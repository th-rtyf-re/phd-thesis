...
\copyrighttext{%
  Stanzas II (p.\ \pageref{C:introduction}), III (p.\ \pageref{C:outlook}), IX (p.\ \pageref{C:metric-morse}), and XII (p.\ \pageref{C:persistent-algebra}) from the poem ``Thirteen Ways of Looking at a Blackbird'' by Wallace Stevens (1879-1955) are in the public domain as of 2012 in the US (95 years after publication), where it was first published in 1917, and as of 2025 in the EU (70 years after the poet's death).
