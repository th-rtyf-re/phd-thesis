...
% \usepackage{flafter} % force figures to appear after they are first referenced
\usepackage{caption}
...
\fancyfoot[RO]{%
  ...
  \AddToHookNext{shipout/background}{
    \ifnum\ReadonlyShipoutCounter<88\relax%
      \put(\paperwidth-30mm,3mm-\paperheight){\input{figs/flip/leo-\fpeval{trunc(\ReadonlyShipoutCounter / 2, 0)}.pgf}}%
    \fi
  }
    %   \ifnum\thepage>179\relax%
    %     \AddToHookNext{shipout/background}{\put(\paperwidth-30mm,3mm-\paperheight){\input{figs/flip/leo-34.pgf}}}%
    %   \fi
  %   \fi%
  % \else%
  %   \if@frontmatter%
...
\def\frontmatter{\oldfrontmatter\@frontmattertrue\pagestyle{front-fancy}}
