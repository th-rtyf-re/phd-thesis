...
\declaretheoremstyle[
  ...
  headformat={\inleftmargin[.5\marginparsep]{\mdseries\textparagraph\,\NUMBER}\NAME \NOTE},
  postheadhook={%
    \checkoddpage%
    \ifoddpageoroneside%
    \else%
...
\declaretheorem[style=theorem-margin]{theorem}
...
\declaretheoremstyle[
  headfont=\sffamily\bfseries,
  headformat={\inleftmargin[.5\marginparsep]{\mdseries{\rmfamily\textparagraph}\,\NUMBER}\NAME \NOTE},
  postheadhook={%
    \checkoddpage%
    \ifoddpageoroneside%
    \else%
