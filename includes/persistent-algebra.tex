...
\begin{definition}
\label{D:free}
  Fix $(I, \leq)$ a poset and $s$ an element of $I$. The \term[free module]{free module at $s$} is the persistence module $\bf{k}_{\{I \geq t\}}$, where $\{I \geq s\} \coloneq \{t \in I \mid t \geq s\}$ is an interval of $I$ (see \cref{D:interval}).
...
\begin{definition}
  Let $V$ be a persistence module over $(I, \leq)$, $(F_*, \partial)$ its minimal projective resolution, and $d \geq 0$ an integer. Recall that all projectives are free: thus the minimal resolution of $V$ looks like
  \[
