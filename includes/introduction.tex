...
In the words of Gunnar Carlsson, a foundational researcher in \index{topological data analysis (TDA)}\textbf{topological data analysis} (\textbf{TDA}), ``data has shape and the shape matters'' \cite{Carlsson2015}. TDA is a relatively new field, established around the turn of the $\text{21}^{\text{st}}$ century, that applies invariants from topology and algebraic topology to understand the topological and geometric structure of data. One of the central objects in TDA, which quantifies the shape of, and encodes information about, data is the \textbf{persistence module}, which essentially is the application %\ir{REVIEW: ?}
of a homology functor to a filtered topological space. In \cref{C:persistent-algebra}, we present \textbf{persistent algebra}, the study of persistence modules, which will be relevant for Papers \ref{PC:CGRST2024}, \ref{PC:AGRS2025}, and \ref{PC:GRRS2026}.
