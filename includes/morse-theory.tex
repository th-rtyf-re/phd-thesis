...
\begin{definition}
  \ir{A continuous selection is... The subdifferential is (general formula for locally Lipschitz), and for continuous selections it is... A critical point is... it is nondegenerate if...}
\end{definition}

\ir{in this case we have Morse lemma (normal form). The rest follows, see paper. See Chapter 4 for details about our contributions.}
...
\begin{definition}
  A \term{real algebraic variety} is the set of solutions of a system of multivariate polynomial equations over the real numbers. \ir{copied from Wikipedia, I guess...}
