...
\section{A selection of Morse theories}
...
\ir{rlative cohomology, reduced cohomology, Betti numbers and $b(X)$, Morse inequalities}

\subsection{Generalizations of Morse theory}

Morse-Bott, stratified Morse theory, topological Morse functions, discrete Morse theory, Morse theory for continuous selections. \ir{idk if this is really needed here...}
