...
\begin{remark}
  Both of these notions fit within the framework of critical points of the distance function from an algebraic variety, restricted to another algebraic variety. In Papers \ref{PC:GRRS2026} and \ref{PC:Ren2026}, we generalize this notion to generic varieties.
\end{remark}