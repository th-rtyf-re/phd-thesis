...
The body typeface is Georgia Pro, originally designed by Matthew Carter in 1996 as the family Georgia, expanded by Steve Matteson, and hinted by Thomas Rickner. Georgia Pro is a serif face in the Scotch Roman style designed to be legible on low-resolution screens, but its elegant forms are equally appreciated at higher resolutions and in print.

The monospace typeface is Fira Code, designed Nikita Prokopov in 2019. It is based on the Fira Mono typeface by Carrois Apostrophe and features an extensive set of ligatures for many programming languages.
