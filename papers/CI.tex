...
\begin{proof}
  By \cref{E!P:transverse-Y-MY}, we can take $\vec{p}$ and $\vec{q}$ generically such that $X$ is transverse to both $Y$ and $\overline{M_Y}$. Let $x$ be an element of $X$. By \cref{E!P:subdiff}, we have
  \[
