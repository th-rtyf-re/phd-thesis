...
\begin{equation}
\label{C!E:iso1}
  \hom (\bigoplus_{i \in I} K(a_i, b_i), \bigoplus_{j \in J} K(c_j, d_j)) \cong \prod_{i \in I} \bigoplus_{j \in J}  \hom (K(a_i, b_i), K(c_j, d_j))
\end{equation}
and
\begin{equation}
\label{C!E:iso2}
...
\label{C!D:Delta}
  ...
  \begin{align*}
    \hom(X, Y) & \cong \prod_{i \in I} \bigoplus_{j \in J} \hom(K(a_i, b_i), K(c_j, d_j)) \\
    & \longrightarrow \prod_{i \in I} \bigoplus_{\substack{j \in J \\ b_i \: = \: d_j}} \hom(K(a_i, b_i), K(c_j, d_j)) \\
